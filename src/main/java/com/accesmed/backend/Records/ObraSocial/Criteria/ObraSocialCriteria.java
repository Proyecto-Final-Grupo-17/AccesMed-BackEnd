package com.accesmed.backend.Records.ObraSocial.Criteria;
...
/**
 * Filtros disponibles para el listado dinámico de {@code ObraSocial} (ver
...
@ToString
@ParameterObject
public class ObraSocialCriteria {
     ...
     * (ver {@code ObraSocialQueryService}); se ignora en caso contrario.
     */
