package com.accesmed.backend.Records.Especialidad.Criteria;
...
/**
 * Filtros disponibles para el listado dinámico de {@code Especialidad} (ver
...
public class EspecialidadCriteria {
     ...
     * (ver {@code EspecialidadQueryService}); se ignora en caso contrario.
     */
