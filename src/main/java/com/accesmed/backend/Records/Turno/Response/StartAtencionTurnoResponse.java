...
/**
 * Response con los datos del turno tras el inicio de su atención.
 *
 ...
 * @param estadoActual estado vigente del turno (EN_CURSO)
 */
public record StartAtencionTurnoResponse(
        UUID id,
        String codigo,
        UUID pacienteId,
        UUID medicoId,
