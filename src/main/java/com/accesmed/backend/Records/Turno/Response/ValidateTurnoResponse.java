...
/**
 * Response con los datos del turno tras su validación.
 *
 ...
 * @param estadoActual estado vigente del turno (PENDIENTE si fue aprobado, CANCELADO si fue rechazado)
 */
public record ValidateTurnoResponse(
        UUID id,
        String codigo,
        UUID pacienteId,
        UUID medicoId,
