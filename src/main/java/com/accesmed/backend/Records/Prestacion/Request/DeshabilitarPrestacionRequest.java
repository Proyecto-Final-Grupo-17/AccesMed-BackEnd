...
/**
 * Record para deshabilitar una prestación (transición terminal e irreversible).
 * El {@code motivo} es opcional.
 */
public record DeshabilitarPrestacionRequest(

        /**
         * Identificador de la prestación a deshabilitar ({@code UUID}).
