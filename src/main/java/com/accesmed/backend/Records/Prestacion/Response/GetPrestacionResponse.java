...
/**
 * Record de respuesta para la obtención de una prestación por identificador.
 * Incluye todos los datos de la prestación y sus indicaciones activas.
 */
public record GetPrestacionResponse(
